...
{
    std::cout << "Test  openssl BIO base64!" << std::endl;
    unsigned char data[] = "测试base64数据01234567890123456789012345678901234567890123456789012345678901234567890123456"
    ...
    if (re > 0)
    {
        /// ncode:[suLK1GJhc2U2NMr9vt0wMTIzNDU2Nzg5MDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTIzNDU2Nzg5MDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTIzNDU2Nzg5MDEyMzQ1Njc4OTAxMjM0NTY3ODkwMTIzNDU2Nzg5AA==]
        out[re] = '\0';
        std::cout << "encode:[" << out << "]" << std::endl;
    }

    re = Base64Decode(out, re, out2);
    std::cout << "decode:" << out2 << std::endl;
